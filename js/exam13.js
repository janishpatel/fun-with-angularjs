...
var app13 = angular.module('app13', ['ngSanitize']);

app13.controller('mainCtrl', function($scope, $window, $location, $interval, $log, $exceptionHandler, $sanitize){
...
app13.directive("getPlayerInfo", function($compile){
